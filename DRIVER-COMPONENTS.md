...
| `export_constants` | `ExportConstants` | statements | 0 | 1 | matcha, parakeet-rnnt, parakeet-tdt, supertonic, vits |
...
*Emits:* statements. *Used by:* matcha, parakeet-rnnt, parakeet-tdt, supertonic, vits.
