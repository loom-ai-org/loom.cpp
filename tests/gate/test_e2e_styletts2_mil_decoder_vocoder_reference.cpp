...
int main() {
    const char* gguf_env = loom_test::fixture_env("LOOM_STYLETTS2_MIL_GGUF");
    const char* ref_dir_env = loom_test::fixture_env("LOOM_STYLETTS2_MIL_DECODER_VOCODER_REF_DIR");
